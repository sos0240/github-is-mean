...
**Status**: SUPERSEDED -- Replaced by jp-jquants-2026-02-25.md (EDINET registration requires website hosting)
**Replacement**: `.roo/research/jp-jquants-2026-02-25.md`
...
df = wb.data.DataFrame(
    ...
    economy="JPN",    # Japan World Bank code
