"""China SSE/SZSE PIT client -- uses Shanghai/Shenzhen exchange APIs.

Primary: SSE API (http://www.sse.com.cn) + SZSE API
Coverage: ~5,000+ listed companies, ~$10T market cap.
"""
...
class CNSseClient:
    """PIT client for Chinese SSE/SZSE equities."""
    ...
    @property
    def market_id(self) -> str: return "cn_sse"
    @property
    def market_name(self) -> str: return "China (SSE / SZSE) -- CSRC"
    ...
    def get_profile(self, identifier: str) -> dict[str, Any]:
        ...
        raw = {"name": "", "ticker": identifier, "isin": "", "country": "CN",
               "sector": "", "industry": "", "exchange": "SSE", "currency": "CNY", "cik": identifier}
